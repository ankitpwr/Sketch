...
export default function AppMenu() {
  ...
  return (
    <div className=" invisible md:visible py-1 rounded-lg fixed left-5  top-20 min-h-86 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
      <AppMenuContainer />
    </div>
  );
}
